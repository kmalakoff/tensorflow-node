...
void Session::run(std::vector<TF_Tensor*>& o_results, TF_SessionWithGraph* session, const std::vector<TF_Operation*>& ops, const v8::Local<v8::Value>& input_pairs, bool outputs) {
