...
static SwigV8ReturnValue _wrap_TF_VERSION_STRING(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  ...
  jsresult = SWIG_FromCharPtr((const char *)"(0.11.0)");
...
static SwigV8ReturnValue _wrap_tensorflow_js_Types_float32(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  ...
  jsresult = SWIG_From_int((int)(tensorflow::js::Types::float32));
...
static SwigV8ReturnValue _wrap_tensorflow_js_Types_float64(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(tensorflow::js::Types::float64));
